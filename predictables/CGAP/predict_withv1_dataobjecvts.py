...
log_file_name = os.path.join(
    os.getcwd(), "logs/", git_details["repo_short_sha"] + ".log"
)
logging.basicConfig(
...
if RUN_ON_SERVER == True:
    sys.path.append(
        "/work/mithunpaul/habitus/clustering/habitus_clulab_repo/predictables/CGAP/Data/Data Objects/Code and Notebooks"
    )
    Data = CGAP_Decoded()
    Data.read_and_decode(
        "/work/mithunpaul/habitus/clustering/habitus_clulab_repo/predictables/CGAP/Data/Data Objects/CGAP_JSON.txt"
    )
else:
    sys.path.append(
        "/Users/mordor/research/habitus_project/clulab_repo/predictables/Data/data_objects/code_and_notebooks"
    )
